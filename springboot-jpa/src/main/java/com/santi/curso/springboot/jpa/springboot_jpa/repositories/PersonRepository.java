package com.santi.curso.springboot.jpa.springboot_jpa.repositories;
...
public interface PersonRepository extends CrudRepository<Person, Long> {
    ...
    @Query("select new com.santi.curso.springboot.jpa.springboot_jpa.dto.PersonDto(p.name, p.lastname) from Person p")
